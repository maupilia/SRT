...
.. warning:: If the number of containers is 0 instead of 33 in ACS, you have to start ACS (see the :ref:`pointing-focus` procedure in the  Discos from Scratch section).
