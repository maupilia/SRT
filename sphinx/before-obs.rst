...
Check that all of the **32 containers** are active on ACS (:numref:`srt_acs`).

.. warning:: If the number of containers is 0 instead of 32 in ACS, you have to start ACS (see the :ref:`Restart-Discos` procedure in the  Discos from Scratch section).
